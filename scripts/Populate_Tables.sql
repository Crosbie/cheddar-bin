...
insert into [dbo].[Cheese_Directories] (cd_path, cd_pass_fail, cd_source_target, cd_active, cd_sort_order) values ('D:\Dropbox\Work\Glanbia\Cheese\cheddar-bin-master\test', 'P', 'S', 'Y', 10)
go
